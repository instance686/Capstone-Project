...
public class ChatAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<ChatCardsEntity> chatCards_entities;
    private Context c;
    private int count = 0;
    ...
    public ChatAdapter(ArrayList<ChatCardsEntity> chatCards_entities, Context c) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ChatCardsEntity chatCards_entity = chatCards_entities.get(position);
    ...
    public void addItem(List<ChatCardsEntity> chatCards_entity) {
        chatCards_entities = (ArrayList<ChatCardsEntity>) chatCards_entity;
